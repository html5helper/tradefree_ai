...
def amz_to_ali_upload(event):
    ...
    time.sleep(25)
    out_event['result'] = {'name': 'amz_to_ali_upload'}
    return out_event
...
def amz_to_1688_upload(event):
    ...
    out_event = event.copy()
    time.sleep(25)
    out_event['result'] = {'name': 'amz_to_1688_upload'}
    return out_event
...
def _1688_to_1688_upload(event):
    ...
    out_event = event.copy()
    time.sleep(25)
    out_event['result'] = {'name': '_1688_to_1688_upload'}
    return out_event
...
def ali_to_ali_upload(event):
    ...
    out_event = event.copy()
    time.sleep(25)
    out_event['result'] = {'name': 'ali_to_ali_upload'}
    return out_event
